                ...
                <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                        <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://drive.google.com/file/d/1TH8UQ5dU-CSmrpq13ElARhUi7WuRodl2/view">Manual y guia de estilos</a>
                            </li>
                        </ul>
                        <form class="form-inline my-2 my-lg-0">
                            <ul class="navbar-nav mr-auto mt-2 mt-md-0">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="user/login.php">Entrar</a>
                                </li>
    ...
    <div class="row"> 
        ...
        for ($j = $i; $j < ($i + 3); $j++) {
            if (isset($personajes[$j])) {
                ...
                echo $personajes[$j]->personajeToHTML();
            }
        }
        ?>
    </div> 
