...
<html lang="en">
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                  <ul class="navbar-nav mr-auto ">
                    <li class="nav-item active">
                      <a type="button" class="btn btn-info " href="insert.php">Crear personaje</a>
                    </li>
                  </ul>
        ...
        <!-- Page Content -->
        <div class="container">
            <form class="form-horizontal" method="post" action="../../../controllers/GestionTarjetas/editController.php">
                <div class="form-group">
                    <label for="name" class="col-sm-2 control-label">Nombre</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nombre" id="name" placeholder="Nombre" value="<?php echo $personaje->getNombre(); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="abilities" class="col-sm-2 control-label">Particularidad</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="abilities" name="particularidad" placeholder="Particularidad" value="<?php echo $personaje->getParticularidad(); ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="avatar" class="col-sm-2 control-label">Avatar</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="avatar" name="avatar" placeholder="Avatar" value="<?php echo $personaje->getAvatar(); ?>">
                    </div>
                </div>
                
                <input type="hidden" name="id" value="<?php echo $personaje->getIdPersonaje(); ?>">
                <div class="form-group">
