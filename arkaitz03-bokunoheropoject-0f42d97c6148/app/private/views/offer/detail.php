    ...
    <body>
        ...
        <div class="container">
           ...
           <div  class=" btn-group card-footer" role="group">
              <a type="button" class="btn btn-success" href="edit.php?id=<?php echo $personaje->getIdPersonaje() ?>">Modificar</a> 
                <a type="button" class="btn btn-danger" href="../controllers/deleteController.php?id=<?php  echo $personaje->getIdPersonaje()?>">Borrar</a> 
             </div>
